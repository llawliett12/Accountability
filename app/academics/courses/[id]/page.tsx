  ...
  return (
    <div className="space-y-6">
      <header className="flex items-center justify-between border-b border-neutral-800/80 pb-3">
        ...
        <Link
          href="/academics"
          className="rounded-lg border border-neutral-800 bg-neutral-900/60 px-2.5 py-1.5 text-xs text-neutral-400 hover:text-neutral-200 transition-colors font-mono"
        >
          &larr; Academics
        </Link>
      </header>
