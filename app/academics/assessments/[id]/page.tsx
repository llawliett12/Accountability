  ...
  return (
    <div className="space-y-6">
      <header className="flex items-center justify-between">
        ...
        <Link href="/academics/assessments" className="text-sm text-neutral-500 underline">
          Back
        </Link>
      </header>
      ...
      {assessment.score !== null && assessment.max_score ? (
        <section className="rounded-2xl bg-neutral-900 p-4">
          ...
          {comparison && (
            <p className={`mt-1 text-sm ${comparison.met ? "text-emerald-400" : "text-amber-400"}`}>
      ...
      <section className="space-y-2 rounded-2xl bg-neutral-900 p-4">
        ...
        {assessment.practice_scores.length > 0 ? (
          ...
          <p className="text-sm text-neutral-500">No practice attempts logged yet.</p>
        )}
