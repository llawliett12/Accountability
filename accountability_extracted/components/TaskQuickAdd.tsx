...
export default function TaskQuickAdd({
  ...
  return (
    <div className="space-y-2 rounded-xl bg-neutral-900 border border-neutral-800/80 p-3">
      {error && (
        <p className="rounded-lg border border-red-800/50 bg-red-950/70 p-2 text-sm text-red-300">
          {error}
        </p>
      )}
            ...
            {showGoalPicker ? (
              <div className="flex gap-1 items-center">
                <select
                  ...
                  className="rounded bg-neutral-800 px-2 py-1 text-sm text-neutral-200 outline-none max-w-[150px]"
                >
                ...
                <button
                  ...
                  className="p-1 text-sm text-neutral-400 hover:text-white"
                >
                  ✕
                </button>
              </div>
              ...
              <button
                ...
                className="rounded bg-neutral-800/60 px-2 py-0.5 text-xs text-neutral-400 hover:text-neutral-200"
              >
                + Goal
              </button>
            )}
