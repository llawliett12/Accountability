...
export default function CanonicalTimetable({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex overflow-x-auto no-scrollbar gap-1 rounded-xl bg-neutral-900 border border-neutral-800/80 p-1 font-mono text-sm">
        {WEEKDAYS.map((d) => {
          ...
          return (
            ...
            >
              ...
              <span className={`text-xs ${isSelected ? "text-neutral-900/70" : "text-neutral-500"}`}>
      ...
      <div className="rounded-xl border border-neutral-800/80 bg-neutral-950/50 overflow-hidden">
        <div className="px-3.5 py-2.5 bg-neutral-900/80 border-b border-neutral-800/80 flex items-center justify-between font-mono text-sm">
        ...
        {dayClasses.length === 0 ? (
          <div className="p-8 text-center font-mono text-sm text-neutral-500 space-y-2">
              ...
              return (
                ...
                >
                  <div className="flex items-baseline gap-3 min-w-0">
                    <span className="font-bold text-amber-300 whitespace-nowrap text-sm">
                  ...
                  <div className="flex items-center gap-2 font-mono text-sm ml-auto">
                    <button
                      type="button"
                      onClick={() => openEditSlot(c)}
                      className="px-2 py-1 rounded bg-neutral-800 text-neutral-300 hover:text-white hover:bg-neutral-700 transition-colors text-xs"
                    >
                      Edit
                    </button>
                    <button
      ...
      {showSlotModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="w-full max-w-md rounded-2xl border border-neutral-800 bg-neutral-950 p-5 space-y-4 shadow-2xl">
            ...
            {slotError && (
              <div className="rounded-lg bg-rose-950/60 border border-rose-800/60 p-2.5 text-sm text-rose-300 font-mono">
                {slotError}
              </div>
            )}

            <form onSubmit={handleSaveSlot} className="space-y-3.5 font-mono text-sm">
              {/* STRICT COURSE DROPDOWN */}
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="text-xs text-neutral-400 uppercase font-semibold block">
                    Course *
                  </label>
                  <button
                    type="button"
                ...
                {activeCourses.length === 0 ? (
                  ...
                  <select
                    ...
                    required
                    className="w-full rounded-lg border border-neutral-800 bg-neutral-900 px-3 py-2 text-neutral-100 focus:outline-none focus:border-amber-400 text-sm"
                  >
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="text-xs text-neutral-400 uppercase font-semibold block mb-1">
                    Day (Mon &ndash; Fri) *
                  </label>
                  <select
                    value={slotDay}
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-neutral-800 bg-neutral-900 px-3 py-2 text-neutral-100 placeholder-neutral-600 focus:outline-none focus:border-amber-400 text-sm"
                />
              </div>
      ...
      {showExtraModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="w-full max-w-md rounded-2xl border border-neutral-800 bg-neutral-950 p-5 space-y-4 shadow-2xl">
            ...
            <form onSubmit={handleSaveExtraClass} className="space-y-3.5 font-mono text-sm">
              <div>
                <label className="text-xs text-neutral-400 uppercase font-semibold block mb-1">
                  Course *
                </label>
          ...
          <div className="w-full max-w-2xl rounded-2xl border border-neutral-800 bg-neutral-950 p-4 space-y-3 shadow-2xl">
            <div className="flex items-center justify-between border-b border-neutral-800/80 pb-2">
              ...
              <button
                ...
                className="rounded px-2 py-1 bg-neutral-800 text-neutral-400 hover:text-white text-sm font-mono"
              >
                Close &times;
              </button>
            </div>
