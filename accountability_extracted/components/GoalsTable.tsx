              ...
              <tr key={goal.id} className="hover:bg-neutral-900/50 transition-colors">
                ...
                <td className="py-3 px-3 font-sans">
                  <div className="flex items-center gap-2">
                    {courseCode && (
                      <span className="rounded bg-neutral-800 border border-neutral-700 px-1.5 py-0.5 text-xs text-amber-300 font-mono font-bold">
                        {courseCode}
                      </span>
                    )}
                    <Link
                ...
                <td className="py-3 px-2 text-center whitespace-nowrap">
                  <span
                    className={`inline-block rounded px-2 py-0.5 text-xs font-bold border ${priorityBadge.class}`}
                  >
                    {priorityBadge.label}
                  </span>
                </td>
                ...
                <td className="py-3 px-2 text-center whitespace-nowrap">
                  <select
                    ...
                    disabled={pending}
                    className={`rounded border px-2 py-1 text-xs font-mono font-semibold outline-none transition-colors ${
