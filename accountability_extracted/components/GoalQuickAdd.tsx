...
export default function GoalQuickAdd({
  ...
  return (
    <section className="space-y-2">
      ...
      /></td><td><select value={level} onChange={(e) => { setLevel(e.target.value as GoalLevel); setParentId(""); }} className="w-full bg-transparent text-sm text-neutral-200 outline-none">
