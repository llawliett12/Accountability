  ...
  return (
    <div className="space-y-2 rounded-2xl bg-neutral-900 p-3">
      ...
      <input
        ...
        className="w-full rounded-lg bg-neutral-800 px-2 py-1.5 text-sm text-neutral-200 outline-none"
      />
      {classes.length > 0 && (
        <select
          value={classId}
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 rounded-lg bg-neutral-800 px-2 py-1.5 text-sm text-neutral-200 outline-none"
        />
        <input
          type="number"
          value={prepHours}
