...
export default function WeeklyTimetableReference({
  ...
  return (
    <section
      ...
      className="rounded-xl border border-neutral-800/80 bg-neutral-900/30 p-3.5 space-y-3"
    >
      {/* HEADER */}
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-between p-2.5">
              <span className="font-mono text-[11px] font-semibold text-white bg-neutral-900/90 border border-neutral-700 px-2 py-0.5 rounded shadow">
                🔍 Tap to enlarge full weekly timetable
              </span>
              <span className="font-mono text-[10px] text-neutral-300">Weekly Reference Photo</span>
            </div>
          </div>
        </div>
      ) : (
        <div className="rounded-lg border border-dashed border-neutral-800 p-4 text-center space-y-1 font-mono text-xs">
      ...
      <div className="border-t border-neutral-800/80 pt-2.5">
        <div className="flex items-center justify-between mb-1.5 font-mono text-[10px] uppercase tracking-wider text-neutral-400 font-semibold">
              ...
              return (
                ...
                >
                  <div className="flex items-baseline gap-2.5 min-w-0">
                    <span className="text-amber-300 font-bold whitespace-nowrap text-[11px]">
            ...
            <div className="flex items-center justify-between border-b border-neutral-800 px-4 py-3 bg-neutral-900/80">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="rounded border border-neutral-700 bg-neutral-800 px-2.5 py-1 font-mono text-xs text-neutral-300 hover:text-white hover:bg-neutral-700 transition-colors"
                >
                ...
                <button
                  ...
                  className="rounded-lg border border-neutral-700 bg-neutral-800 px-3 py-1 font-mono text-xs font-bold text-neutral-300 hover:text-white hover:bg-neutral-700 transition-colors"
