  ...
  return (
    <div className="flex items-center justify-between gap-3 rounded-xl bg-neutral-900 p-3 text-sm">
      <div className="min-w-0 flex-1">
        ...
        <p className="text-sm text-neutral-500">{deadline.due_date}</p>
      </div>
      <button
        type="button"
        onClick={toggle}
        disabled={pending}
        className={`shrink-0 min-h-[44px] rounded-xl px-3.5 py-2 text-sm font-medium transition-colors disabled:opacity-50 ${
