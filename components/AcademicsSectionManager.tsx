    ...
    <>
      ...
      {!activeSection && (
        <div className="space-y-5">
          ...
          <section aria-label="Active Courses" className="rounded-xl border border-neutral-800/80 bg-neutral-900/30 p-3.5 space-y-2.5">
            <div className="flex items-center justify-between">
              <h2 className="font-mono text-xs uppercase tracking-wider text-neutral-300 font-bold">
                My Courses ({activeCourses.length})
              </h2>
              <span className="font-mono text-[10px] text-neutral-500">Tap a course for details</span>
            </div>

            {activeCourses.length === 0 ? (
              <p className="font-mono text-xs text-neutral-500 py-2">
              ...
              <div className="divide-y divide-neutral-800/60 font-mono text-xs">
                {activeCourses.map((crs) => (
                  ...
                  >
                    ...
                    <span className="text-neutral-500 group-hover:text-neutral-300 text-xs transition-colors">
                      &rarr;
                    </span>
                  </Link>
                ))}
