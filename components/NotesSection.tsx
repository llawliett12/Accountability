...
export default function NotesSection({
  ...
  return (
    <section className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-3.5 space-y-3 font-mono text-xs">
      <div className="flex items-center justify-between">
        ...
        {!isAdding && (
          <button
            ...
            className="rounded border border-neutral-700 bg-neutral-800 px-2.5 py-1 text-[11px] text-neutral-200 hover:bg-neutral-700 transition-colors"
          >
            + Add Note
          </button>
        )}
      ...
      {isAdding && (
        <form onSubmit={handleAdd} className="space-y-2 rounded-lg border border-neutral-700 bg-neutral-950 p-2.5">
          <textarea
            ...
            className="w-full rounded border border-neutral-800 bg-neutral-900 p-2 text-xs text-neutral-100 placeholder-neutral-600 focus:border-neutral-600 focus:outline-none"
          />
              ...
              {editingId === note.id ? (
                <div className="space-y-2">
                  <textarea
                    ...
                    className="w-full rounded border border-neutral-700 bg-neutral-900 p-2 text-xs text-neutral-100 focus:border-amber-500 focus:outline-none"
                  />
                  <div className="flex justify-end gap-2">
                    <button
                      type="button"
                    ...
                    <button
                      ...
                      className="rounded bg-neutral-100 px-2.5 py-0.5 font-semibold text-neutral-950 hover:bg-neutral-200 text-[11px]"
                    >
                      Save
                    </button>
                  </div>
