...
export default function RolloverBanner({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-2 border-y border-amber-800/60 bg-amber-950/20 px-3 py-2 text-sm">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="rounded bg-amber-400 hover:bg-amber-300 text-neutral-950 px-2.5 py-1 text-xs font-semibold transition-colors disabled:opacity-50 whitespace-nowrap"
        >
