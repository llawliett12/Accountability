...
import { createCheckIn, deleteCheckIn, updateCheckIn } from "@/lib/actions";
    ...
    <section className="space-y-2">
      ...
      <div className="ledger-scroll">
        <table className="ledger-table min-w-[360px]">
          <thead>
            <tr><th className="w-12">S.No</th><th>Work</th><th className="w-20">Time</th><th className="w-20"></th></tr>
          </thead>
          <tbody>
