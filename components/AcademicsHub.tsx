        ...
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={`min-h-[44px] flex-1 min-w-[90px] flex items-center justify-center gap-1.5 rounded-xl px-3 py-2 text-sm font-semibold transition-all whitespace-nowrap ${
                isActive
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-lg bg-neutral-800 hover:bg-neutral-700 px-3 py-1.5 text-sm font-semibold text-neutral-200 transition-colors"
        >
      ...
      {showAdd && (
        ...
        >
          <div className="text-sm font-medium text-neutral-300">New Assessment Entry</div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <input
              ...
              className="rounded-lg bg-neutral-800 px-3 py-2 text-sm text-neutral-100 outline-none"
              required
            />
            <select
              value={classId}
              onChange={(e) => setClassId(e.target.value)}
              className="rounded-lg bg-neutral-800 px-3 py-2 text-sm text-neutral-200 outline-none"
            >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            <select
              ...
              className="rounded-lg bg-neutral-800 px-3 py-1.5 text-sm text-neutral-200 outline-none"
            >
            ...
            <input
              ...
              className="rounded-lg bg-neutral-800 px-2 py-1.5 text-sm text-neutral-200 outline-none"
              required
            />
            <input
              type="number"
          ...
          <button
            ...
            className="w-full rounded-lg bg-white py-2 text-sm font-semibold text-neutral-950 disabled:opacity-50"
          >
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-neutral-400">Assignments, projects, and submission tracker</p>
        </div>
        <button
          type="button"
          onClick={() => setShowAdd(!showAdd)}
          className="rounded-lg bg-neutral-800 hover:bg-neutral-700 px-3 py-1.5 text-sm font-semibold text-neutral-200"
        >
      ...
      {showAdd && (
        <form
          ...
          className="border-y border-neutral-800 bg-neutral-950/30 py-3 space-y-3"
        >
          <div className="text-sm font-medium text-neutral-300">New Deadline</div>
          <input
            type="text"
            placeholder="Assignment or submission title..."
            value={title}
            onChange={(e) => setTitle(e.target.value)}
            className="w-full rounded-lg bg-neutral-800 px-3 py-2 text-sm text-neutral-100 outline-none"
            required
          />
      ...
      <div className="overflow-x-auto border-y sm:border border-neutral-800/80 sm:rounded-xl bg-neutral-950/50">
        <table className="w-full text-left text-sm border-collapse min-w-[460px]">
          ...
          <tbody className="divide-y divide-neutral-800/60 font-mono text-sm">
              ...
              return (
                ...
                >
                  ...
                  <td className="py-2.5 px-2 text-center whitespace-nowrap">
                    {isDone ? (
                      <span className="rounded px-1.5 py-0.5 text-[11px] font-semibold uppercase bg-emerald-950/70 border border-emerald-800/60 text-emerald-300">
                        Completed
                      </span>
                    ) : isOverdue ? (
                      <span className="rounded px-1.5 py-0.5 text-[11px] font-semibold uppercase bg-red-950/70 border border-red-800/60 text-red-300">
                        Overdue
                      </span>
                    ) : (
                      <span className="rounded px-1.5 py-0.5 text-[11px] font-semibold uppercase bg-neutral-900 border border-neutral-800 text-neutral-400">
                        Incomplete
                      </span>
                    )}
                  </td>
            ...
            {deadlines.length === 0 && (
              <tr>
                <td colSpan={6} className="py-6 text-center text-sm text-neutral-500 font-mono">
...
function PerformanceSection({
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="border border-neutral-800/80 rounded-xl bg-neutral-950/60 p-3 flex items-center justify-between font-mono text-sm">
        <div>
          <span className="text-xs uppercase text-neutral-500 block">Overall Average</span>
      ...
      <div className="overflow-x-auto border-y sm:border border-neutral-800/80 sm:rounded-xl bg-neutral-950/50">
        <table className="w-full text-left text-sm border-collapse min-w-[420px]">
          ...
          <tbody className="divide-y divide-neutral-800/60 font-mono text-sm">
              ...
              return (
                <Fragment key={classKey}>
                  ...
                  >
                    ...
                    <td className="py-2.5 px-3 text-right text-amber-400 hover:text-amber-300 text-xs">
                        ...
                        <div className="space-y-1 pl-2 border-l-2 border-amber-500/40">
                          {tests.map((t) => {
                            ...
                            return (
                              <div
                                key={t.id}
                                className="flex items-center justify-between text-sm py-1 text-neutral-300"
                              >
            ...
            {scoredAssessments.length === 0 && (
              <tr>
                <td colSpan={4} className="py-6 text-center text-sm text-neutral-500 font-mono">
