    ...
    <div className="space-y-2">
      ...
      {showAddBlock && (
        <form
          ...
          className="flex flex-wrap items-center gap-2 border border-neutral-800 bg-neutral-900/70 p-2.5 rounded-lg text-sm"
        >
          <input
            type="text"
          ...
          <div className="flex items-center gap-1.5">
            <input
              ...
              className="bg-neutral-800 px-2 py-1.5 rounded text-neutral-200 outline-none font-mono text-sm"
            />
            <select
              value={blockDuration}
          ...
          <tbody className="divide-y divide-neutral-800/60">
            {items.map((item) => {
              ...
              return (
                ...
                >
                  {/* Time */}
                  <td className="py-2.5 px-3 font-mono text-sm text-amber-400/90 whitespace-nowrap">
                    {timeDisplay}
                  </td>
                  ...
                  <td className="py-2.5 px-2 text-center whitespace-nowrap">
                    {isClass ? (
                      <span className="rounded px-1.5 py-0.5 text-[11px] font-mono font-semibold uppercase bg-cyan-950/70 border border-cyan-800/60 text-cyan-300">
                        Class
                      </span>
                    ) : (
                      <span className="rounded px-1.5 py-0.5 text-[11px] font-mono font-semibold uppercase bg-purple-950/70 border border-purple-800/60 text-purple-300">
                        Block
                      </span>
                    )}
                  </td>
                    ...
                    {isClass ? (
                      <div className="inline-flex items-center gap-1.5 justify-end">
                        <button
                          ...
                          className={`min-h-[32px] px-2.5 py-1 rounded text-xs font-medium transition-colors ${
