...
export default function WhatAmIDoingInput() {
  ...
  return (
    <section aria-label="Quick Activity Journal" className="rounded-xl border border-neutral-800/80 bg-neutral-900/40 p-3">
      <div className="flex items-center justify-between mb-2">
        <label htmlFor="what-am-i-doing" className="font-mono text-[10px] uppercase tracking-wider text-neutral-400 font-semibold">
          What Am I Doing?
        </label>
        {lastLogged && (
          <span className="font-mono text-[10px] text-emerald-400 truncate max-w-[200px]">
            ✓ {lastLogged}
          </span>
        )}
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        ...
        <button
          ...
          className="rounded-lg bg-neutral-100 px-3 py-2 font-mono text-xs font-semibold text-neutral-950 transition-colors hover:bg-neutral-200 disabled:opacity-40"
        >
          {pending ? "..." : "Log"}
        </button>
      </form>
