    ...
    <>
      ...
      <div className={activeSection ? "hidden" : "space-y-4"}>
          ...
          <section
            ...
            className="space-y-2.5 pt-1 font-mono"
          >
            <div className="flex items-center justify-between border-b border-neutral-800/70 pb-2">
              ...
              <span className="text-xs text-neutral-500">7d &amp; 30d Trends</span>
            </div>

            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-sm">
              {/* Sleep Averages */}
              <div className="rounded-lg bg-neutral-900/40 p-2.5 space-y-1">
                <div className="text-xs text-neutral-400 uppercase font-semibold">Sleep</div>
                <div className="text-base font-bold text-white">
                  {averages.sleepAvg7d !== null ? `${averages.sleepAvg7d}h` : "--"}
                  <span className="text-xs font-normal text-neutral-500 ml-1">7d</span>
                </div>
              ...
              {/* Meditation Averages */}
              <div className="rounded-lg bg-neutral-900/40 p-2.5 space-y-1">
                <div className="text-xs text-neutral-400 uppercase font-semibold">Meditation</div>
              ...
              <div className="rounded-lg bg-neutral-900/40 p-2.5 space-y-1">
                <div className="text-xs text-neutral-400 uppercase font-semibold">Screen Time</div>
              ...
              {/* Food Consistency */}
              <div className="rounded-lg bg-neutral-900/40 p-2.5 space-y-1">
                <div className="text-xs text-neutral-400 uppercase font-semibold">Food Logged</div>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            <div className="rounded-lg bg-neutral-900/40 p-3">
              <div className="text-xs font-mono text-neutral-500 uppercase">Last Night Sleep</div>
            ...
            <div className="rounded-lg bg-neutral-900/40 p-3">
              <div className="text-xs font-mono text-neutral-500 uppercase">Sleep Quality</div>
            ...
            <div className="col-span-2 sm:col-span-1 rounded-lg bg-neutral-900/40 p-3">
              <div className="text-xs font-mono text-neutral-500 uppercase">7-Day Average</div>
              <div className="text-xl font-bold font-mono text-white mt-1">
                {averages.sleepAvg7d !== null ? `${averages.sleepAvg7d}h` : "--"}
              </div>
                    ...
                    {recentMeditationLogs.map((log) => (
                      <tr key={log.id} className="hover:bg-neutral-900/30">
                        ...
                        <td className="py-2 px-3">
                          <span className={`inline-block px-1.5 py-0.5 rounded text-xs font-semibold ${log.happened ? "bg-emerald-950/80 text-emerald-300" : "bg-neutral-900 text-neutral-500"}`}>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 pt-1">
            ...
            {todayScreenTime?.topApps && todayScreenTime.topApps.length > 0 ? (
              <div className="space-y-2 pt-2">
                <div className="text-sm font-mono text-neutral-400">Top Applications:</div>
                <div className="space-y-1.5">
                  {todayScreenTime.topApps.map((app) => (
                    <div
                      key={app.app_name}
                      className="flex items-center justify-between py-1 px-2.5 rounded bg-neutral-950/60 border border-neutral-800/80 text-sm font-mono"
                    >
            ...
            <div className="pt-2 flex gap-3">
              <Link
                href="/screen-time"
                className="inline-flex items-center rounded-lg bg-neutral-800 hover:bg-neutral-700 px-3 py-1.5 text-sm font-mono text-amber-300 transition-colors"
              >
      ...
      {activeSection === "trends" && (
        <section className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="overflow-x-auto border border-neutral-800 rounded-xl bg-neutral-950/50">
              <table className="w-full text-left text-sm font-mono min-w-[480px]">
                <thead>
                  <tr className="border-b border-neutral-800 bg-neutral-900/80 text-xs text-neutral-400 uppercase tracking-wider">
