...
export default function ReconciliationList({ tasks }: { tasks: Task[] }) {
  ...
  if (tasks.length === 0) {
    return (
      <p className="text-sm text-neutral-500 font-mono py-2">
  ...
  return (
    <div className="overflow-x-auto border border-neutral-800/80 rounded-lg bg-neutral-950/40">
      <table className="w-full text-left text-sm border-collapse min-w-[340px]">
        <thead>
            ...
            <tr key={task.id} className="hover:bg-neutral-900/50 transition-colors">
              ...
              <td className="py-2 px-3 text-right">
                <select
                  ...
                  className="rounded bg-neutral-800 border border-neutral-700 px-2 py-1 text-sm text-neutral-200 outline-none cursor-pointer"
                >
